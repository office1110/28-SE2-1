...
{
	public partial class EvaCom : System.Web.UI.Page
	{
		...
		public void TestButtonEnable()
		{
			...
			if (currentQNo == 0)
			{
				...
				ButtonFns.Visible = false;
				ButtonFns.Enabled = false;
			}
			else if (currentQNo == Test_Final.resultCount - 1)
			{
				ButtonNxt.Enabled = false;
				ButtonFns.Visible = true;
				ButtonFns.Enabled = true;
			}
			else if (currentQNo == Test_Final.resultCount)
			{
				currentQNo = 0;
				ButtonFns.Visible = false;
				ButtonFns.Enabled = false;
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (corList[currentQNo].Category == "S    " || corList[currentQNo].Category == "M    " || corList[currentQNo].Category == "R    ")
			{
				if(corList[currentQNo].Answer == mineList[currentQNo].Answer)
				{
			...
			else
			{
				...
				LabelResult.Text = "Exam Master cannot evaluate this question for you.";
			}
		}
